...
from habitat_baselines.common.base_trainer import BaseGruRLTrainer
from habitat_baselines.common.baseline_registry import baseline_registry
from habitat_baselines.common.env_utils import construct_envs
from habitat_baselines.common.environments import get_env_class
from habitat_baselines.common.rollout_storage import RolloutStorageGruBaseline
...
from habitat_baselines.rl.ppo import (
    PPOGruBaseline, PolicyGruBaseline
    )


@baseline_registry.register_trainer(name="gru-baseline")
class PPOGruTrainer(BaseGruRLTrainer):
    ...
    def _setup_actor_critic_agent(self, ppo_cfg: Config) -> None:
        ...
        self.actor_critic = PolicyGruBaseline(
    ...
    def train(self) -> None:
        ...
        rollouts = RolloutStorageGruBaseline(
            ppo_cfg.num_steps,
            self.envs.num_envs,
